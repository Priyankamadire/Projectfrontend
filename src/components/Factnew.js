...
const Factnew = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://projectbackends.onrender.com/newfa_');
  ...
  const PostData = async (e) => {
    ...
    const res = await fetch("https://projectbackends.onrender.com/nfaculty" , {
      method:"POST",
      headers:{
  ...
  return (
    <div>
      ...
      <center><h1><em>Details of Faculty who joined newly to  the institute</em></h1></center>
      <div>
        <br />
        <br />
          ...
          <table style={{ width: "100%" }} className="text-dark" method='POST'>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input type="string" name="newinstituteid" id="newinstituteid" value={admin.newinstituteid} onChange={handleInputs} />
                </td>
                <td>
